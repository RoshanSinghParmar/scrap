...
my_url ='https://www.youtube.com/results?search_query=travel+videos'
...
csv_file=open("done.csv","w",encoding="utf-8")
csv_writer=csv.writer(csv_file)
csv_writer.writerow(['VideoID','Title','Description','Category'])
